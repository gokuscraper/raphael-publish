...
export const ALL_PLATFORMS: PlatformMeta[] = [
    ...
    { type: 'yuque', name: '语雀', icon: 'https://gw.alipayobjects.com/zos/rmsportal/UTjFYEzMSYVwzxIGVhMu.png', homepage: 'https://www.yuque.com/dashboard' },
    { type: 'douban', name: '豆瓣', icon: 'https://www.douban.com/favicon.ico', homepage: 'https://www.douban.com/note/create' },
    { type: 'sohu', name: '搜狐号', icon: 'https://mp.sohu.com/favicon.ico', homepage: 'https://mp.sohu.com' },
    { type: 'xueqiu', name: '雪球', icon: 'https://xueqiu.com/favicon.ico', homepage: 'https://xueqiu.com' },
    { type: 'woshipm', name: '人人都是产品经理', icon: 'https://www.woshipm.com/favicon.ico', homepage: 'https://www.woshipm.com' },
    { type: 'cto51', name: '51CTO', icon: 'https://www.51cto.com/favicon.ico', homepage: 'https://blog.51cto.com' },
    ...
    { type: 'eastmoney', name: '东方财富', icon: 'https://mp.eastmoney.com/favicon.ico', homepage: 'https://mp.eastmoney.com' },
    { type: 'douyin', name: '抖音图文', icon: 'https://www.douyin.com/favicon.ico', homepage: 'https://www.douyin.com' },
    { type: 'dayu', name: '大鱼号', icon: 'https://mp.dayu.com/favicon.ico', homepage: 'https://mp.dayu.com' },
    { type: 'yidian', name: '一点号', icon: 'https://www.yidianzixun.com/favicon.ico', homepage: 'https://www.yidianzixun.com' },
    { type: 'sohufocus', name: '搜狐焦点', icon: 'https://m.focus.cn/favicon.ico', homepage: 'https://m.focus.cn' },
    { type: 'smzdm', name: '什么值得买', icon: 'https://www.smzdm.com/favicon.ico', homepage: 'https://www.smzdm.com' },
    { type: 'netease', name: '网易号', icon: 'https://mp.163.com/favicon.ico', homepage: 'https://mp.163.com' },
    { type: 'x', name: 'Twitter/X', icon: 'https://abs.twimg.com/favicons/twitter.ico', homepage: 'https://x.com' },
    { type: 'wordpress', name: 'WordPress', icon: 'https://s.w.org/images/favicon.ico', homepage: '' },
    { type: 'typecho', name: 'Typecho', icon: '', homepage: '' },
];
